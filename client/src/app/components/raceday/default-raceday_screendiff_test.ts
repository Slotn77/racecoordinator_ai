...
test.describe("Raceday Visuals for Fuel", () => {
  ...
  test("should display driver avatars when column is configured", async ({
    page,
  }) => {
    await TestSetupHelper.setupSettings(page, {
  ...
  test("should scale fuel gauge correctly on 1-lane track", async ({
    page,
  }) => {
    await TestSetupHelper.setupSettings(page, {
      racedayColumns: [
      ...
      columnLayouts: {
        ...
        lapCount: { CenterCenter: "lapCount" },
        "imageset_fuel-gauge-builtin": {
          CenterCenter: "imageset_fuel-gauge-builtin",
        },
  ...
  test("should scale fuel gauge correctly on 8-lane track", async ({
    page,
  }) => {
    await TestSetupHelper.setupSettings(page, {
      racedayColumns: [
  ...
  test("should show team driver selection pulldown with stats", async ({
    page,
  }) => {
