...
export class TrackEditorHarnessE2e implements TrackEditorHarnessBase {
  ...
  private get base() {
    return TrackEditorHarnessBase;
  }

  private get nameInput() {
    return this.locator.locator(this.base.selectors.nameInput);
  }
  private get laneItems() {
    return this.locator.locator(this.base.selectors.laneItem);
  }
  private get addLaneButton() {
    return this.locator.locator(this.base.selectors.addLaneButton);
  }
  private get addInterfaceButton() {
    return this.locator.locator(this.base.selectors.addInterfaceButton);
  }
  private get arduinoEditors() {
    return this.locator.locator("app-arduino-editor");
  }
  private get duplicateButton() {
    return this.locator.locator(this.base.selectors.duplicateButton);
  }
  ...
  async getLaneLength(index: number): Promise<number> {
    ...
    const val = await item
      .locator(this.base.selectors.laneLengthInput)
      .inputValue();
